...
<form action="cadastrarCavalo.php" method="POST" id="cadastro">
	...
	<p>Nome do Cavalo: <input type="text" name="nome" size="30" maxlength="30" pattern="[A-Za-zçÇáÁãÃâÂàÀêÊéÉèÈíÍìÌóÓôÔòÒõÕ\s]{2,30}" required></p>
	<p>Raça do Cavalo: <input type="text" name="raca" size="30" maxlength="30" pattern="[A-Za-zçÇáÁãÃâÂàÀêÊéÉèÈíÍìÌóÓôÔòÒõÕ\s]{2,30}" required></p>
	<p>Data de Nascimento: <input type="date" name="datanasc" min="2000-01-01" max="2030-01-01" required></p>
	<p>Sexo do Cavalo: <input type="radio" name="sexo" value="macho" required>Macho <input type="radio" name="sexo" value="femea" required />Fêmea </p>
		...
		<p>Raça do Pai: <input type="text" name="racadopai" size="30" maxlength="30" pattern="[A-Za-zçÇáÁãÃâÂàÀêÊéÉèÈíÍìÌóÓôÔòÒõÕ\s]{2,30}" required> </p>
		...
		<p>Raça da Mãe: <input type="text" name="racadamae" size="30" maxlength="30" pattern="[A-Za-çÇáÁãÃâÂàÀêÊéÉèÈíÍìÌóÓôÔòÒõÕ\s]{2,30}" required></p>
		</br>
